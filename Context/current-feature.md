...
Phase 2D-2A — Managed Savings Groups Foundation (COMPLETED AND VERIFIED — Product Owner browser QA approved, committed and merged into `master`)
...
- **Phase 2D-2C: Managed Savings Groups — Cross-Group Drag-and-Drop** — Not started; no scope defined yet. Recommended final sub-phase per the Phase 2D-2 planning audit (dragging a holding from one group's table into another).
